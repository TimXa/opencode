export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von Кит",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von Кит wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
