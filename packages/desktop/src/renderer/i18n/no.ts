export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av Кит",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av Кит er lastet ned. Vil du installere den og starte på nytt?",
