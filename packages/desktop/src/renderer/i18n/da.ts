export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Кит",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Кит er blevet downloadet. Vil du installere den og genstarte?",
