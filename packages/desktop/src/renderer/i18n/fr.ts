export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'Кит",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'Кит a été téléchargée. Voulez-vous l'installer et redémarrer ?",
