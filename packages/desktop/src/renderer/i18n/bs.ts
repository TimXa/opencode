export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju Кит-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} Кит-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
