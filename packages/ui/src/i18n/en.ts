export const dict: Record<string, string> = {
  ...
  "dialog.usageExceeded.freeTier.description":
    "Subscribe to Кит Go for reliable access to the best open-source models, starting at $5/month.",
  ...
  "ui.sessionTurn.status.performingActions": "Working",
  "ui.sessionTurn.status.performedActions": "Done",
  ...
  "ui.messagePart.activity.web.one": "searched the web {{count}} time",
  "ui.messagePart.activity.web.other": "searched the web {{count}} times",
  "ui.messagePart.activity.edit.one": "edited {{count}} file",
  "ui.messagePart.activity.edit.other": "edited {{count}} files",
  "ui.messagePart.activity.command.one": "ran {{count}} command",
  "ui.messagePart.activity.command.other": "ran {{count}} commands",
