export const dict = {
  ...
  "dialog.usageExceeded.freeTier.description":
    "Подпишитесь на Кит Go для надёжного доступа к лучшим моделям с открытым исходным кодом, от $5/месяц.",
  ...
  "ui.sessionTurn.status.performingActions": "Работает",
  "ui.sessionTurn.status.performedActions": "Готово",
  ...
  "ui.messagePart.activity.web.one": "{{count}} раз изучил интернет",
  "ui.messagePart.activity.web.other": "{{count}} раз изучил интернет",
  "ui.messagePart.activity.edit.one": "отредактировал {{count}} файл",
  "ui.messagePart.activity.edit.other": "отредактировал {{count}} файла",
  "ui.messagePart.activity.command.one": "выполнил {{count}} команду",
  "ui.messagePart.activity.command.other": "выполнил {{count}} команды",
