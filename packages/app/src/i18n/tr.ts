...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Кит tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Кит'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.opencodeZen.line1":
    "Кит Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Кит'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Кит'da {{provider}} modellerini kullanın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Кит sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Кит kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde Кит kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "Кит güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde Кит güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki Кит'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "Кит'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde Кит hazır.",
  "wsl.onboarding.opencodeReady": "Кит hazır.",
  "wsl.onboarding.installOpencodeIn": "Кит'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "Кит'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Кит kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Кит'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Кит bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Кит'u tekrar açın.",
  ...
  "toast.update.description": "Кит'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Кит ekibine bildirin",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Кит henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Кит ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "settings.desktop.wsl.description": "Кит sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Кит'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Кит'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Кит'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Кит'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Кит başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Кит'un en son sürümünü kullanıyorsunuz.",
