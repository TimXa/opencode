export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Кит",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Кит.",
  ...
  "provider.connect.opencodeZen.line1":
    "Кит Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Кит.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Кит.",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Кит se conecta esta app.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando Кит...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando Кит en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando Кит...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando Кит en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza Кит en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar Кит",
  "wsl.onboarding.opencodeReadyIn": "Кит está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "Кит está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala Кит en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar Кит",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Кит no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Кит pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Кит no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Кит.",
  ...
  "toast.update.description": "Una nueva versión de Кит ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Кит",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Кит no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "Кит incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Кит dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Кит",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Кит en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Кит sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Кит.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Кит",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Кит.",
