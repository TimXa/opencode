...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Кит",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Кит.",
  ...
  "provider.connect.opencodeZen.line1":
    "Кит Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Кит.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Кит.",
  ...
  "dialog.server.description": "Bytt hvilken Кит-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Кит ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Кит-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Кит ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Кит inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Кит-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Кит",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Кит ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Кит skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Кит er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Кит starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Кит.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker Кит...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker Кит i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer Кит...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer Кит i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater Кит i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater Кит",
  "wsl.onboarding.opencodeReadyIn": "Кит er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "Кит er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer Кит i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Кит er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Кит kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Кит kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Кит på nytt.",
