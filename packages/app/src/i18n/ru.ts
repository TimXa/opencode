export const dict = {
  ...
  "command.session.previous": "Предыдущий чат",
  "command.session.next": "Следующий чат",
  "command.session.previous.unseen": "Предыдущий непрочитанный чат",
  "command.session.next.unseen": "Следующий непрочитанный чат",
  "command.session.archive": "Архивировать чат",
  ...
  "command.agent.cycle": "Выбрать помощника",
  ...
  "command.model.variant.cycle": "Выбрать режим мышления",
  "command.model.variant.cycle.description": "Переключиться к следующему уровню усилий",
  "command.prompt.mode.shell": "Командный режим",
  ...
  "command.session.compact": "Сжать чат",
  "command.session.compact.description": "Сократить чат, чтобы освободить контекст",
  "command.session.fork": "Создать ответвление",
  "command.session.fork.description": "Создать новый чат из сообщения",
  "command.session.share": "Поделиться чатом",
  "command.session.share.description": "Опубликовать чат и скопировать ссылку",
  "command.session.unshare": "Отменить публикацию",
  "command.session.unshare.description": "Прекратить публикацию чата",

  "palette.search.placeholder": "Поиск файлов, команд и чатов",
  "palette.search.placeholder.home": "Поиск команд и чатов",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от Кит",
  ...
  "provider.connect.apiKey.description":
    "Введите ваш API ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в Кит.",
  ...
  "provider.connect.opencodeZen.line1":
    "Кит Zen даёт вам доступ к отобранным надёжным оптимизированным моделям для агентов программирования.",
  ...
  "provider.connect.opencodeZen.visit.link": "primekit-job.ru",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в Кит.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в Кит.",
  ...
  "session.child.promptDisabled": "В дочерних чатах нельзя отправлять запросы.",
  "session.child.backToParent": "Вернуться к основному чату.",
  ...
  "prompt.toast.sessionCreateFailed.title": "Не удалось создать чат",
  ...
  "prompt.toast.promptSendFailed.description": "Не удалось открыть чат",
  ...
  "dialog.plugins.empty": "Плагины настроены в kit.json",
  ...
  "dialog.server.description": "Переключите сервер Кит к которому подключается приложение.",
  ...
  "wsl.onboarding.step.opencode": "Кит",
  ...
  "wsl.onboarding.checkingOpencode": "Проверка Кит...",
  "wsl.onboarding.checkingOpencodeIn": "Проверка Кит в {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Обновление Кит...",
  "wsl.onboarding.updatingOpencodeIn": "Обновление Кит в {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Обновите Кит в {{distro}}.",
  "wsl.onboarding.updateOpencode": "Обновить Кит",
  "wsl.onboarding.opencodeReadyIn": "Кит в {{distro}} готов к работе.",
  "wsl.onboarding.opencodeReady": "Кит готов к работе.",
  "wsl.onboarding.installOpencodeIn": "Установите Кит в {{distro}}.",
  "wsl.onboarding.installOpencode": "Установить Кит",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Кит не установлен",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для добавления сервера WSL в Кит требуется WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "Кит не смог проверить WSL на этом компьютере.",
  "wsl.onboarding.installWsl": "Установить WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустите Windows, чтобы завершить установку WSL, затем снова откройте Кит.",
  ...
  "toast.model.none.description": "Подключите модель для краткого пересказа чата",
  ...
  "toast.session.share.failed.title": "Не удалось опубликовать чат",
  "toast.session.share.failed.description": "Не удалось опубликовать чат",
  ...
  "toast.session.listFailed.title": "Не удалось загрузить чаты для {{project}}",

  "toast.update.title": "Доступно обновление",
  "toast.update.description": "Новая версия Кит ({{version}}) доступна для установки.",
  ...
  "error.chain.checkConfig": "Проверьте названия провайдера/модели в конфиге (kit.json)",
  "error.chain.mcpFailed":
    'MCP сервер "{{name}}" завершился с ошибкой. Обратите внимание, что Кит пока не поддерживает MCP авторизацию.',
  ...
  "notification.action.goToSession": "Перейти к чату",

  "notification.session.responseReady.title": "Ответ готов",
  "notification.session.error.title": "Ошибка чата",
  ...
  "home.sessions.search.placeholder": "Поиск чатов",
  "home.sessions.search.placeholder.scoped": "Поиск чатов в {{scope}}",
  "home.sessions.search.sessions": "Чаты",
  "home.sessions.search.noResults": "Чаты по запросу {{query}} не найдены",
  "home.sessions.empty": "Здесь пока ничего нет",
  "home.sessions.empty.description": "Создайте чат, чтобы начать",
  ...
  "session.tab.unknown": "Неизвестный чат",
  "session.panel.reviewAndFiles": "Обзор и файлы",
  "session.error.notFound": "Этот чат не найден",
  "session.error.notFound.description": "Эта вкладка указывает на чат, которого больше нет на сервере.",
  ...
  "session.review.empty": "Изменений в этом чате пока нет",
  "session.review.noVcs": "Система контроля версий Git не обнаружена, изменения не отображаются",
  "session.review.noSnapshot": "Отслеживание снимков отключено в настройках, поэтому изменения чата недоступны",
  ...
  "session.new.workspace.runIn": "Открыть чат в",
  ...
  "session.share.popover.description.shared": "Этот чат опубликован. Его может открыть любой, у кого есть ссылка.",
  "session.share.popover.description.unshared": "Опубликуйте чат. Его сможет открыть любой, у кого есть ссылка.",
  ...
  "sidebar.nav.projectsAndSessions": "Проекты и чаты",
  ...
  "sidebar.gettingStarted.line1": "Кит включает бесплатные модели, чтобы вы могли начать сразу.",
  "sidebar.gettingStarted.line2":
    "Подключите любого провайдера для использования моделей, включая Claude, GPT, Gemini и др.",
  "sidebar.project.recentSessions": "Недавние чаты",
  "sidebar.project.viewAllSessions": "Посмотреть все чаты",
  ...
  "settings.desktop.wsl.description": "Запускать сервер Кит внутри WSL на Windows.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения Кит",
  ...
  "settings.general.row.appearance.description": "Настройте как Кит выглядит на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли Кит системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление Кит.",
  ...
  "settings.general.row.showFileTree.description": "Показывать дерево файлов в чатах",
  ...
  "settings.general.row.mobileTitlebarBottom.description":
    "На мобильных устройствах размещать заголовок и вкладки чата внизу экрана",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске Кит",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию Кит.",
  "sound.option.none": "Нет",
  "sound.option.alert01": "Alert 01",
  "sound.option.alert02": "Alert 02",
  "sound.option.alert03": "Сигнал",
  ...
  "sound.option.bipbop02": "Короткий",
  ...
  "sound.option.staplebops01": "Готово",
  "sound.option.staplebops02": "Внимание",
  ...
  "sound.option.yup01": "Подтверждение",
  ...
  "settings.general.notifications.agent.title": "Джарвис",
  "settings.general.notifications.agent.description":
    "Показывать уведомление, когда задача завершена или требует внимания",
  "settings.general.notifications.permissions.title": "Разрешения",
  "settings.general.notifications.permissions.description": "Показывать уведомление, когда требуется разрешение",
  "settings.general.notifications.errors.title": "Ошибки",
  "settings.general.notifications.errors.description": "Показывать уведомление при ошибке",

  "settings.general.sounds.agent.title": "Джарвис",
  "settings.general.sounds.agent.description": "Воспроизводить звук, когда задача завершена или требует внимания",
  ...
  "settings.general.sounds.errors.description": "Воспроизводить звук при ошибке",
  ...
  "session.delete.failed.title": "Не удалось удалить чат",
  "session.delete.title": "Удалить чат",
  "session.delete.confirm": 'Удалить чат "{{name}}"?',
  "session.delete.button": "Удалить чат",
  ...
  "workspace.reset.archived.none": "Активные чаты не будут архивированы.",
  "workspace.reset.archived.one": "1 чат будет архивирован.",
  "workspace.reset.archived.many": "Чатов будет архивировано: {{count}}.",
