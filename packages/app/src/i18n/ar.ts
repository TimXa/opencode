export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Кит",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Кит.",
  ...
  "provider.connect.opencodeZen.line1":
    "يمنحك Кит Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Кит.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Кит.",
  ...
  "dialog.server.description": "تبديل خادم Кит الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من Кит...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من Кит في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث Кит...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث Кит في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث Кит في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث Кит",
  "wsl.onboarding.opencodeReadyIn": "Кит جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "Кит جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت Кит في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت Кит",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Кит غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Кит من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Кит التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Кит.",
  ...
  "toast.update.description": "نسخة جديدة من Кит ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Кит",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Кит لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Кит نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Кит داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Кит",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Кит على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Кит يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Кит.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Кит",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Кит.",
