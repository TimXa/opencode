export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Кит",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Кит.",
  ...
  "provider.connect.opencodeZen.line1":
    "Кит Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Кит.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Кит.",
  ...
  "dialog.server.description": "Trocar para qual servidor Кит este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o Кит...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o Кит em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o Кит...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o Кит em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o Кит em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o Кит",
  "wsl.onboarding.opencodeReadyIn": "O Кит está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O Кит está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o Кит em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o Кит",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Кит não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Кит possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Кит não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Кит novamente.",
  ...
  "toast.update.description": "Uma nova versão do Кит ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Кит",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Кит ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Кит inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Кит dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Кит",
  ...
  "settings.general.row.appearance.description": "Personalize como o Кит aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Кит segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Кит é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Кит iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Кит.",
