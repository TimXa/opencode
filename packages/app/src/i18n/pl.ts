export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Кит",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Кит.",
  ...
  "provider.connect.opencodeZen.line1":
    "Кит Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Кит.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Кит.",
  ...
  "dialog.server.description": "Przełącz serwer Кит, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie Кит...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie Кит w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie Кит...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie Кит w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj Кит w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj Кит",
  "wsl.onboarding.opencodeReadyIn": "Кит jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Кит jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj Кит w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj Кит",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Кит nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Кит będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Кит nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Кит.",
  ...
  "toast.update.description": "Nowa wersja Кит ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Кит",
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Кит nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "Кит zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Кит wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Кит",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Кит na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Кит ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Кит.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Кит",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Кит.",
