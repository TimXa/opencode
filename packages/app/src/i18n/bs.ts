export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Кит",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Кит-u.",
  ...
  "provider.connect.opencodeZen.line1":
    "Кит Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Кит-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Кит-u.",
  ...
  "dialog.server.description": "Promijeni na koji se Кит server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera Кит...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera Кит u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Кит...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Кит u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj Кит u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj Кит",
  "wsl.onboarding.opencodeReadyIn": "Кит je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Кит je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj Кит u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj Кит",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Кит nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Кит mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Кит nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Кит.",
  ...
  "toast.update.description": "Nova verzija Кит-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Кит timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Кит još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Кит uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Кит server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Кит-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Кит izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Кит prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Кит-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Кит pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Кит-a.",
