export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Кит",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Кит.",
  ...
  "provider.connect.opencodeZen.line1":
    "Кит Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Кит.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Кит.",
  ...
  "dialog.server.description": "Changez le serveur Кит auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'Кит...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'Кит dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'Кит...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'Кит dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour Кит dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour Кит",
  "wsl.onboarding.opencodeReadyIn": "Кит est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "Кит est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez Кит dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer Кит",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Кит non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Кит puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Кит n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Кит.",
  ...
  "toast.update.description":
    "Une nouvelle version d'Кит ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Кит",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Кит ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Кит inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Кит dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Кит",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Кит sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Кит suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Кит.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Кит",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Кит.",
