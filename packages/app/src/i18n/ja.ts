export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Китが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Китで{{provider}}モデルを使用します。",
  ...
  "provider.connect.opencodeZen.line1":
    "Кит Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してКитで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Китで{{provider}}モデルを使用してください。",
  ...
  "dialog.server.description": "このアプリが接続するКитサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "Китを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のКитを確認中...",
  "wsl.onboarding.updatingOpencode": "Китを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のКитを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のКитを更新してください。",
  "wsl.onboarding.updateOpencode": "Китを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のКитの準備ができました。",
  "wsl.onboarding.opencodeReady": "Китの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にКитをインストールしてください。",
  "wsl.onboarding.installOpencode": "Китをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Китがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "КитでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Китをもう一度開いてください。",
  ...
  "toast.update.description": "Китの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをКитチームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: КитはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Китには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でКитサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Китの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのКитの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Китがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Китのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Кит の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Кит は最新バージョンです。",
