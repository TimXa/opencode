...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Кит",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Кит zu nutzen.",
  ...
  "provider.connect.opencodeZen.line1":
    "Кит Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in Кит zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Кит zu nutzen.",
  ...
  "dialog.server.description": "Wechseln Sie den Кит-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingOpencode": "Кит wird geprüft...",
  "wsl.onboarding.checkingOpencodeIn": "Кит in {{distro}} wird geprüft...",
  "wsl.onboarding.updatingOpencode": "Кит wird aktualisiert...",
  "wsl.onboarding.updatingOpencodeIn": "Кит in {{distro}} wird aktualisiert...",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie Кит in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Кит aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "Кит ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "Кит ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie Кит in {{distro}}.",
  "wsl.onboarding.installOpencode": "Кит installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Кит nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Кит einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Кит konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Кит erneut.",
  ...
  "toast.update.description": "Eine neue Version von Кит ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Кит-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Кит unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "Кит enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "Кит-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Кит ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Кит auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Кит dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Кит anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Кит automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von Кит.",
