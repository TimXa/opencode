export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Кит",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Кит.",
  ...
  "provider.connect.opencodeZen.line1":
    "Кит Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Кит.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Кит.",
  ...
  "dialog.server.description": "Skift hvilken Кит-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker Кит...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker Кит i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer Кит...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer Кит i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater Кит i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater Кит",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Кит er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Кит kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Кит kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Кит igen.",
  ...
  "toast.update.description": "En ny version af Кит ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Кит-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Кит understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Кит inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Кит-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Кит",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Кит ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om Кит følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Кит er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Кит starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Кит.",
