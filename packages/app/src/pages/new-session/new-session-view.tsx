...
export function NewSessionView(props: {
  ...
  return (
    <div class="@container relative flex flex-col min-h-0 h-full flex-1">
      ...
      >
        <div class="absolute inset-0 flex flex-col items-center px-6 pb-7 pt-12">
          <div class="flex flex-1 flex-col items-center justify-center pb-16 text-center">
            <Mark class="mb-6 size-12 text-v2-icon-icon-faint" />
            <h1 class="text-[30px] font-medium tracking-[-0.025em] text-v2-text-text-strong">
              Над чем поработаем в PrimeKit?
            </h1>
          </div>
